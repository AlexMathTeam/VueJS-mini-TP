<template>
  <div class="container-gestion-restaurants">
    <section class="container-search-restaurants">
      <header></header>
      <main>
        <AfficheRestaurant v-for="restaurant in restaurants" :key="restaurant" :restaurant="restaurant"></AfficheRestaurant>
      </main>
    </section>
  </div>
</template>
